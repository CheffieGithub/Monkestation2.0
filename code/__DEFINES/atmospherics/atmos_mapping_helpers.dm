...
/// Same as default atmos with oxygen replaced with n2
#define OPENTURF_NITROGEN "n2=104;TEMP=293.15"
/// Same as low pressure with n2
#define OPENTURF_NITROGEN_LOW "n2=44;TEMP=293.15"
/// Default mix with added c02
#define OPENTURF_AIR_CO2 "o2=22;n2=82;co2=37;TEMP=293.15"
/// Same as default atmos with co2
#define OPENTURF_CO2 "co2=104;TEMP=293.15"
/// Same as low pressure with co2
#define OPENTURF_CO2_LOW "co2=44;TEMP=293.15"
